@extends('layouts.app')
 @section("pageTitle",'Policy Report')
 {{--@section("pageSubtitle",'create, edit, delete Claims')--}}
  @section("breadcrumbs")
            <li>Reports</li>
            <li>Policies report</li>
         @endsection
@section('content')
    {{--<div class="col-md-12">--}}
        {{--<div class="box">--}}
    ...
    <section class="invoice no-print">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ url('getPoliciesReport') }}" id="policies-form" method="post">
                    {{ csrf_field() }}
                    ...
                    if(data.length > 0){
                        for(var i=0; i<data.length; i++){
                            html += '<tr>' +
                                ...
                                '<td>'+ data[i].policy_type+'</td>' +
                                '<td>'+ data[i].name+'</td>' +
                                '<td>'+ data[i].amount_insured+'</td>' +
