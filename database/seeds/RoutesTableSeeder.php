...
//        $child->roles()->attach($admin);
        ...
        $child = Route::create([
            'route_name'=>'Deposit Refunds Report',
            'parent_route' => $parent->id,
            'url'=>'depositReport'
        ]);
        $child->roles()->attach($admin);
